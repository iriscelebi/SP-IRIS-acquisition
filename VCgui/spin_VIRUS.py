...
def __spincam_gui():
	...
	led_on_button_pos = [0.5 - but_width,
					   1 - 2 * padding - but_height,
					   but_width,
					   but_height]
	...
	resetNPC_button_pos = [led_on_button_pos[0] + 4*but_width,
					   1 - 2 * padding - but_height,
					   but_width,
					   but_height]
	...
	pump_button_pos = [led_on_button_pos[0] + 6*but_width,
					   1 - 2 * padding - but_height,
					   but_width,
					   but_height]
	pump_button_axes = fig.add_axes(pump_button_pos)
	pump_button = Button(pump_button_axes, 'PUMP')
	pump_button.label.set_fontsize(8)
	pump_button.on_clicked(__open_pump)
    
    ###############################
	# current position
	z_pos_but_pos = [0.4 - options_height,
	...
	####################### Set z step size
	z_step_text_pos1 = [0.4 - options_height,
	...
	time_btwn_z_text = TextBox(time_btwn_z_text_axes, 'time between z stacks (s) ')
	...
	z_up_button_pos1 = [0.5 + 0.5*but_width,
					   z_step_text_pos2[1],
					   but_width,
					   but_height]
